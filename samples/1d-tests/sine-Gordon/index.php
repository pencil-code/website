...
Looking into the subroutine "calc_pencils_special", we see that "p%Vprime=phimass2*lambda_phi*sin(lambda_phi*p%phi)".
...
In the code, it says that this means "phi=4.*amplphi*atan(exp(phi_gam*kx_phi*(x-offset)))",
