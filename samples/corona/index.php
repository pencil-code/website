...
<p>We show here a view from top onto the coronal model that features several hot loops with extreme-UV emission in the spectral lines of, e.g., Fe XV, which is generated by million Kelvin hot plasma.
This emission clearly follows, as expected, the magnetic field, because the heat conduction is very efficient parallel to the magnetic field lines.
As responsible for the coronal energy input, we could identify the vertical Poynting flux into the corona, that is caused by horizontal shuffling motions by advection of magnetic field lines in the photosphere, where the plasma beta is large and hence the granulation performs the so-called field-line braiding mechanism to inject magnetic energy.
...
The model is driven by an active regeion magnetogram observed in the photosphere and reproduces well observations of the corona.
