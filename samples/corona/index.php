...
As responsible for the coronal energy input, we could identify the vertical Poynting flux into the corona (blue/red = positive/negative, right panel), that is caused by horizontal shuffling motions by advection of magnetic field lines in the photosphere, where the plasma beta is large and hence the granulation performs the so-called field-line braiding mechanism to inject magnetic energy.
