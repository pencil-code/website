...
<img align="right" src="/samples/turbulence/pslice.png" width="250" height="200" border="1" hspace="20" >

Contours of (a) <i>B<sub>z</sub>(x,y)</i> and (b) <i>u<sub>z</sub>(x,y)</i>.
The insets show a zoom into the small square in the lower left corner.


<h2>Inverse transfer in nonhelial turbulence</h2>
...
<img align="right" src="/samples/turbulence/pkt2304_hel_short2304pm1_kf60b_noforce.png" width="250" height="200" border="1" hspace="20" >
<img align="right" src="/samples/turbulence/pkt2304_hel_short2304pm100_kf60b_noforce.png" width="250" height="200" border="1" hspace="20" >

(a) Magnetic (solid lines) and kinetic (dashed lines) energy
spectra for Run~A at times t/&tau;<sub>A</sub>=18, 130, 450, and 1800;
the time t/&tau;<sub>A</sub>=450 is shown as bold lines.
The straight lines indicate the slopes k<sup>4</sup> (solid, blue),
k<sup>2</sup> (dashed, blue), and k<sup>-2</sup> (red, solid).
(b) Same for Run~B, at t/&tau;<sub>A</sub>==540, 1300, and 1800, with
